...
void intHandler(int senal) {
    if(senal == SIGINT ){
        cout<<"Nodo naranja terminado exitosamente"<<endl;
        int stat;
        waitpid(pid, &stat, 0);
...
//argv[2] nombre del archivo del grafo
...
int main(int argc, char * argv[]){
    ...
    cout << "Nodo naranja inicializado" <<endl;
    pid = fork();
    if (pid == 0) {
            ...
            if(hilo == 0) {
                ...
                while(1){
                    ...
                    if(req.port){ //saco algo
                        ...
                        cout<<"Llega solicitud: "<<*solicitud<<endl;
                ...
                while(1){
                    for(int i = 0; i < cola_de_Connect.size();++i){
                        ...
                        while(!ID_aceptado){
                            ...
                            int indice_verde = (rand()+1) % naranja.getSizeGrafo();
                            num_ID_verde = IDs_verdes_disponibles[indice_verde];
                            ...
                            for(int j = 0 ; j < vecinos_naranja.size();j++){
                                ...
                                cout << "Se manda request_pos a nodo naranja: " << vecinos_naranja[j].nombre<< " IP: " <<  vecinos_naranja[j].IP << ":" << vecinos_naranja[j].puerto << endl;
                            ...
                            if(ID_aceptado){
                              ...
                              cout << "ID no aceptado, consiguiendo nuevo ID " << ID_aceptado << endl;
                            }
                        ...
                        for(int j = 0; j < vecinos_naranja.size(); j++){
                            ...
                            cout << "Se manda confirm pos" << endl;
                        ...
                        naranja.connect_ACK(&ACK,cola_de_Connect[i].port,cola_de_Connect[i].IP,*numDeRequestConnect,*temp);
